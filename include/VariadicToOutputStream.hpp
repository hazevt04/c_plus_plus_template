...
// From
// https://stackoverflow.com/questions/8629382/debug-macro-for-c-with-variable-arguments-without-the-format-string/8629465
...
class VariadicToOutputStream {
 public:
   ...
   ~VariadicToOutputStream() { m_stream << std::endl; }
